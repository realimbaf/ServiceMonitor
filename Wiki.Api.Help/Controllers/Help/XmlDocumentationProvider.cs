...
namespace Wiki.Api.Help.Controllers.Help
{
    ...
    public class XmlDocumentationProvider : IDocumentationProvider, IModelDocumentationProvider
    {
        ...
        public XmlDocumentationProvider()
        {
            ...
            var fn = Path.Combine(new FileInfo(assembly.Location).DirectoryName,  "Wiki.ServiceHost.xml");
            Stream stream;

            if (File.Exists(fn))
                stream = new MemoryStream(File.ReadAllBytes(fn));
            else
                stream = assembly.GetManifestResourceStream("Wiki.ServiceHost.App_Data.XmlDocument.xml");
